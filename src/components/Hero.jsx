...
import profilePic from "../assets/Passport pic.jpg";
      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center ">
            <motion.img initial={{x:100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:1,delay:1.2}} src={profilePic} alt="pic" className="h-45 rounded-3xl" />
          </div>
        </div>
      </div>
    </div>
